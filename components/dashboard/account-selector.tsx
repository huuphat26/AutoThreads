            ...
            <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-sm mx-4 overflow-hidden">
                ...
                <div className="px-5 pt-5 pb-3">
                    ...
                    <p className="text-xs text-slate-500 leading-relaxed">
                        Bạn sẽ dùng tài khoản <strong>{account.name}</strong> đăng nội dung nào,
                        sheet data nào? Hãy đảm bảo bạn đã import nội dung phù hợp
                        cho tài khoản này trong tab <strong>Content Pool</strong>.
                    </p>
                </div>
                ...
                <div className="mx-5 mb-4 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
                    <p className="text-[10px] text-amber-700 leading-relaxed">
                        💡 Nội dung trong Content Pool được phân theo tài khoản.
                        Import file xlsx riêng cho mỗi tài khoản để quản lý nội dung độc lập.
                    </p>
                </div>
...
export function AccountSelector({
    ...
    const [pendingAccount, setPendingAccount] = useState<AccountSafe | null>(null);
